 ...
 */
- (__nonnull CVPixelBufferRef)recorder:(SCRecorder *__nonnull)recorder didOutputVideoPixelBuffer:(__nonnull CVPixelBufferRef)videoBuffer depthBuffer:(__nonnull CVPixelBufferRef) depthBuffer formatDescription:(__nonnull CMFormatDescriptionRef) formatDescription faceMetadata:(AVMetadataObject * _Nullable )faceMetadata;
...
/**
 Called when the recorder detects face features
 */
- (void)recorder:(SCRecorder *__nonnull)recorder didDetectFaceFeatures:(NSArray *__nonnull)features;

/**
 Called when the recorder outputs a CIImage
 */
- (void)recorder:(SCRecorder *__nonnull)recorder didOutputPixelBuffer:(__nonnull CVPixelBufferRef)pixelBuffer;
